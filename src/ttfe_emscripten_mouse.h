...
static inline void web_focus_canvas(void) {
    EM_ASM({
...
static inline void web_request_pointer_lock(void) {
    g_pl_wanted = true;
    web_focus_canvas();
...
static inline void web_exit_pointer_lock(void) {
    g_pl_wanted = false;
...
*/
static inline bool mouse_capture_active(const GameContext* ctx) {
...
static inline void web_init_pointer_lock(GameContext* ctx) {
